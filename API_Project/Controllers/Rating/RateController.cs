...
namespace API_Project.Controllers
{
    ...
    public class RateController: ControllerBase
    {
        ...
        public RateController(IHostingEnvironment hostingEnvironment)
        {
        ...
        [Route("add")]
        [HttpGet]
        public BaseModel<object> Add(Rating data)
        {
